...
- **`complexity_level_for` appliqué au total projet** : l'échelle est **par fichier** (plafond 40), or le total projet (571) y passe → **tout projet non trivial est « critical »**. Même famille que la dette « deux échelles » d'[[ADR-0010]]. Pré-existant, rendu plus visible par #50. → **Issue #60**.
